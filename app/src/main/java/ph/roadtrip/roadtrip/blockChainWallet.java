...
public class blockChainWallet extends AppCompatActivity {
    ...
    public void blockChainBalance(Context context, String bcAddress){
        final RequestQueue requestQueue = Volley.newRequestQueue(context);
        String new_add = "get_address_balance";
        String server_urlpost = "https://block.io/api/v2/"+new_add +"/?api_key=4a06-1e71-bac7-fb7a&addresses="+bcAddress; //Points to target which is obtained from IPV4 Address from IP Config
